...
typedef enum {
    ...
    APP_EVT_HIGH_POWER_ACTIVE,
    APP_EVT_HIGH_POWER_CLEARED,

    APP_EVT_COMMAND_RELAY_OPEN,
    APP_EVT_COMMAND_RELAY_CLOSE,
    APP_EVT_COMMAND_RELAY_TOGGLE,
    APP_EVT_COMMAND_CONFIG_UPDATE,

    APP_EVT_FAULT_RAISED,
    APP_EVT_FAULT_CLEARED,

    APP_EVT_REPROVISIONING_INDICATE_REQUESTED,
    APP_EVT_FACTORY_RESET_INDICATE_REQUESTED,
