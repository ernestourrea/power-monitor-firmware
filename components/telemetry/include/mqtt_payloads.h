...
esp_err_t mqtt_payload_build_alert_flags(uint32_t flags, uint32_t active_flags, uint8_t severity, uint64_t timestamp_ms, bool cleared, char *out, size_t out_len);
